...
lecture = Lecture.create(title: "Test Lecture", number: 1, body: "Lecture Body", author: admin, active: true, tools: [tool], level: level, subjects: [subject], languages: [language])
